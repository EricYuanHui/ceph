...
struct TestMockImageStore : public TestMockFixture {
...
TEST_F(TestMockImageStore, ImageStoreInit) {
...
TEST_F(TestMockImageStore, ImageStoreShutDown) {
  librbd::ImageCtx *ictx = nullptr;
  MockAioFile t_mock_aio_file(*ictx, "test");
...
TEST_F(TestMockImageStore, ImageStoreReadBlock) {
  librbd::ImageCtx *ictx = nullptr;
  uint64_t t_offset = 0;
  uint64_t t_length = 1;
  Context *t_on_finish = nullptr;
...
TEST_F(TestMockImageStore, ImageStoreWriteBlock) {
  librbd::ImageCtx *ictx = nullptr;
  uint64_t t_offset = 0;
...
TEST_F(TestMockImageStore, ImageStoreReset) {
  librbd::ImageCtx *ictx = nullptr;
  uint64_t t_length = 1;
  bool t_fdatasync = false;
  Context *t_on_finish = nullptr;
